...
//import byow.Core2.Graph;
import byow.Core2.Room;
...
//    }
//
////    private ArrayList grafiquito(int cuartoNumero) {
////        int[][] grafico = new int[cuartoNumero][cuartoNumero];
////        grafico = Graph.connectAll(cuartoNumero, cuartosDelMundo, grafico);
////        ArrayList losBordes = Graph.primMST(cuartoNumero, grafico);
////        return losBordes;
////    }
//
...
//        grafico = Graph.connectAll(cuartoNumero, cuartosDelMundo, grafico);
//        ArrayList losBordes = Graph.primMST(cuartoNumero, grafico);
////        ArrayList losBordes2 = grafiquito(cuartoNumero);
////        int contador = 0;
////        while (contador < losBordes.size()) {
//        for (Object losBorde : losBordes) {
...
//            Cuartos cuartoUno = cuartosDelMundo.get(identificacionCuarto1);
//            Cuartos cuartoDos = cuartosDelMundo.get(identificacionCuarto2);
