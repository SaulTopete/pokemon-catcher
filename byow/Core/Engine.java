...
//        PuntosCardinales avatarPoint = getAvatarPos(loadedWorld);
//
//        long myLong = Long.parseLong(seedString);
//
//        World newWorld = new World(WIDTH, HEIGHT, myLong, avatarPoint);
//
//        TETile[][] darkWorldFrame = TETile.copyOf(loadedWorld);
//
//        newWorld.makeDark(loadedWorld, darkWorldFrame);
//
//        HUD hd = new HUD(WIDTH, HEIGHT, nameString);
//
//        int mouseX;
//        int mouseY;
...
//            hd.updateHUD(newWorld, mouseX, mouseY, loadedWorld);
...
//    }
//
//    public static void saveCurrent(String game, String name, String seed, PuntosCardinales pos, String dark) {
...
//        return seedString;
//    }
//    public PuntosCardinales getPos() {
//        String posString = "";
//        try {
...
//        return new PuntosCardinales(avatarX, avatarY);
//    }
//
...
//    }
//
////    public void initWorld(World thisWorld, TETile[][] tiles, long seed) {
////        int roomNum = thisWorld.numeroAletorioCuartos(seed);
////        thisWorld.nuevoMundoNada(tiles);
////        thisWorld.dibujoCuarto(tiles, roomNum);
////        thisWorld.dibujoVestibulo(tiles, roomNum);
////        thisWorld.limpiador(tiles);
////    }
//
//
//    /**
...
//            Pantalla screen = new Pantalla(40, 40); // Start screen
//            screen.loreScreen();
//            String nameString = "";
//            if (c.equals("T")) {
...
//    }
//
//    public void setUp(LinkedList<String> temp, String seedString) {
//        temp.add(0, "N");
...
//
//
//            Elmundo newWorld = new Elmundo(WIDTH, HEIGHT, myLong);
//            AvatarControl ac = new AvatarControl(WIDTH, HEIGHT, avatarPoint);
//
//            newWorld.nuevoMundoNada(finalWorldFrame);
//            int roomNum = newWorld.numeroAletorioCuartos(myLong);
//            newWorld.dibujoCuarto(finalWorldFrame, roomNum);
//            newWorld.dibujoVestibulo(finalWorldFrame, roomNum);
//            newWorld.limpiador(finalWorldFrame);
//            //ter.renderFrame(finalWorldFrame);
//            for (char a : moves.toCharArray()) {
//                TETile[][] darkWorldFrame = TETile.copyOf(finalWorldFrame);
//                ac.controlarAlAvatar(finalWorldFrame, darkWorldFrame, a);
//            }
//
//            PuntosCardinales avatarPos = getAvatarPos(finalWorldFrame);
...
//            String seedString = getSeed();
//            PuntosCardinales avatarPos = getPos();
//            long myLong = Long.parseLong(seedString);
//            TETile[][] finalWorldFrame = new TETile[WIDTH][HEIGHT];
//            //ter.initialize(WIDTH, HEIGHT);
//
//            Elmundo newWorld = new Elmundo(WIDTH, HEIGHT, myLong);
//            AvatarControl ac = new AvatarControl(WIDTH, HEIGHT, new PuntosCardinales(0, 0));
//
//            newWorld.nuevoMundoNada(finalWorldFrame);
//            int roomNum = newWorld.numeroAletorioCuartos(myLong);
//            newWorld.dibujoCuarto(finalWorldFrame, roomNum);
//            newWorld.dibujoVestibulo(finalWorldFrame, roomNum);
//            newWorld.limpiador(finalWorldFrame);
//            ac.establecerAvatarPuntos(finalWorldFrame, avatarPos);
//            for (char a : moves.toCharArray()) {
//                TETile[][] newWorldFrame = TETile.copyOf(finalWorldFrame);
//                ac.controlarAlAvatar(finalWorldFrame, newWorldFrame, a);
//            }
//
//            PuntosCardinales avatarPoint = getAvatarPos(finalWorldFrame);
