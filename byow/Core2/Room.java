...
//        int potentialX = byow.Core.RandomUtils.uniform(random, 0, maxX);
//        int potentialY = byow.Core.RandomUtils.uniform(random, 0, maxY);
//
//        this.start = new Point<>(potentialX, potentialY);
//        this.width = byow.Core.RandomUtils.uniform(random, 6, 10);
