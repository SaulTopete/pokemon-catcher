...
//                if (i != j) {
//                    graph[i][j] = rooms.get(i).coneccionDeCuartos(rooms.get(j));
//                }
//            }
//        }
//        return graph;
...
//     */
//
//    public static ArrayList<PuntosCardinales> getEdgy(int[] origin, int numRooms) {
//
//        ArrayList<PuntosCardinales> edgePoints = new ArrayList<>();
//        for (int i = 1; i < numRooms; i++) {
//            PuntosCardinales edge = new PuntosCardinales(origin[i], i);
//            edgePoints.add(edge);
//        }
//        return edgePoints;
//    }
